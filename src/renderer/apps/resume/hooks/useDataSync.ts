...
export function useDataSync() {
  ...
  return {
    ...
    sync: {
      ...
      handleResync: activePipeline.handleResync,
    },
    records: {
    ...
    retry: {
      handleRetryFailed: activePipeline.handleRetryFailed,
      handleRetryFailedVectorization: activePipeline.handleRetryFailedVectorization,
      handleRetryIncomplete: activePipeline.handleRetryIncomplete,
      handleRetryNotProcessed: activePipeline.handleRetryNotProcessed,
    },
