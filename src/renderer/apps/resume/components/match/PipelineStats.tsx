...
const PipelineStats = memo(function PipelineStats({ stats, pipelineStages, onStageClick }: PipelineStatsProps) {
                    ...
                    <table className="w-full text-xs">
                      ...
                      <tbody>
                        {sortedCandidateTimings.map((ct, idx) => (
                          ...
                          >
                            <td className="py-1.5 pr-4 text-primary font-mono truncate max-w-[180px]" title={ct.name}>{ct.name}</td>
