      ...
      case 'pdf':
        return (
          <svg className="w-6 h-6 text-red-500 dark:text-red-400" fill="currentColor" viewBox="0 0 20 20">
            <path d="M4 18h12V6l-4-4H4v16zm8-14l4 4h-4V4z" />
          </svg>
        );
      case 'docx':
      case 'doc':
        return (
          <svg className="w-6 h-6 text-accent-500 dark:text-accent-400" fill="currentColor" viewBox="0 0 20 20">
            <path d="M4 18h12V6l-4-4H4v16zm8-14l4 4h-4V4z" />
          </svg>
        );
      default:
    ...
    <div className="w-full">
      <div
        ...
        className={`
          ...
          ${
            isDragging
              ? 'border-accent-400 bg-accent-50/50 dark:bg-accent-500/10'
              : 'border-gray-200/50 dark:border-dark-border/50 hover:border-gray-300 dark:hover:border-dark-muted bg-white/30 dark:bg-dark-surface/30 hover:bg-white/50 dark:hover:bg-dark-hover/30'
          }
        `}
      >
        <input
        ...
        <div className="mt-4">
          ...
          <div className="space-y-1.5 max-h-48 overflow-y-auto">
            {selectedFiles.map((file, index) => (
              <div
                key={index}
                className="flex items-center gap-2.5 p-2.5 bg-white/50 dark:bg-dark-hover/30 rounded-xl border border-gray-100/50 dark:border-dark-border/30"
              >
                ...
                <button
                  ...
                  className="p-1 text-gray-400 hover:text-red-500 dark:hover:text-red-400 rounded-lg hover:bg-red-50/50 dark:hover:bg-red-900/20 transition-colors"
                >
