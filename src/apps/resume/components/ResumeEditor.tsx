...
export default function ResumeEditor({
  ...
  const toggleOriginalExpanded = (section: string) => {
  ...
  const renderOriginalBlock = (section: string, content: React.ReactNode) => {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="glass-card overflow-hidden">
        ...
        {expandedSections.has('summary') && (
          <>
            ...
            {renderOriginalBlock('summary',
              <p className="text-sm text-secondary italic">{originalResume?.summary}</p>
            )}
          </>
        )}
      </div>
      ...
      <div className="glass-card overflow-hidden">
        {renderSectionHeader('Work Experience', 'experience', (
          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        {expandedSections.has('experience') && (
          <>
              ...
              {resume.experience.map((exp, index) => (
                <div key={exp.id} className="p-3 bg-white/50 dark:bg-dark-hover/30 rounded-xl border border-gray-100/50 dark:border-dark-border/30">
                  ...
                  <p className="text-sm font-medium text-primary mb-1.5">
                    ...
                    {exp.projectName && (
                      <>{' — '}{renderEditableText(exp.projectName, `exp-${index}-project`, (v) =>
                        updateExperience(index, 'projectName' as any, v)
                      )}</>
                    )}
                  </p>
            ...
            {renderOriginalBlock('experience',
              <div className="space-y-3">
      ...
      <div className="glass-card overflow-hidden">
        ...
        {expandedSections.has('certifications') && (
          <>
            ...
            {renderOriginalBlock('certifications',
      ...
      <div className="glass-card overflow-hidden">
        {renderSectionHeader('Academic Background', 'education', (
          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
