...
- Name: navigation.spec.ts >> Agents: Scout-9 settings
- Location: e2e/cdp/navigation.spec.ts:141:5

# Error details

```
Error: ErrorBoundary triggered on file:///Users/eduardo.torres/Downloads/COE%20Operation%20Nexus/out/renderer/index.html#/agents/scout-9/settings: Minified React error #185; visit https://react.dev/errors/185 for the full message or use the non-minified dev environment for full errors and additional helpful warnings.
```
